...
const popUp_function = () => {
  ...
  function convertCSVtoArray(str) { // 読み込んだCSVデータが文字列として渡される
    ...
    if (state === 1) {
      // alert(result[cont][1]); // modeless 表示したい result[cont][1]を渡したい
      // html 呼び出ししたい
      text = result[cont][1];
      // window.open("../Modeless/modeLess.html", null, 'top=200,left=200,width=200,height=200');
    }
  }
  getCSV(); //最初に実行される
}
